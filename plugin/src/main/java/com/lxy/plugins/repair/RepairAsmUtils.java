...
//
//
//public final class RepairAsmUtils {
//
//    public final static String REDIRECTFIELD_NAME = "changeQuickRedirect"; //重定向名字
...
//     * @param isStatic
//     */
//    public static void createInsertCode(MethodVisitor mv, String className, List<Type> args, Type returnType, boolean isStatic, int methodId) {
...
//    }
//
//    private static void prepareMethodParameters(MethodVisitor mv, String className, List<Type> args, Type returnType, boolean isStatic) {
...
//    }
//
//    private static void createReturnClass(MethodVisitor mv, Type returnType) {
//        redirectLocal(mv, returnType);
//    }
//
//    private static void createClassArray(MethodVisitor mv, List<Type> args) {
...
//     * optionally this.
//     */
//    protected static void createLocals(MethodVisitor mv, List<Type> args) {
//        mv.push(args.size());
...
//     */
//    protected static void redirectLocal(MethodVisitor mv, Type arg) {
